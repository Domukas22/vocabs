...
import { FORMAT_publicListVocabCount } from "../../../formatVocabCount/FORMAT_publicListVocabCount/FORMAT_publicListVocabCount";
import { FetchedSharedList_PROPS } from "../../../props";
import { FETCH_listIdsSharedWithMe } from "../../FETCH_listIdsSharedWithMe/FETCH_listIdsSharedWithMe";

export function USE_supabaseLists({
  search,
  user_id,
  ...
  const fetch = useCallback(
    async (start: number, end: number) => {
      ...
      try {
        ...
        SET_lists((prev) => [
          ...prev,
          ...(FORMAT_publicListVocabCount(lists) || []),
        ]);
