...
import { BUILD_vocabSortingQuery } from "./BUILD_vocabSortingQuery";
...
describe("BUILD_vocabSortingQuery", () => {
  ...
  test("1. Applies difficulty sorting when sorting is 'difficulty'", () => {
    ...
    BUILD_vocabSortingQuery(mockQuery, args);
  ...
  test("10. Throws error when query is undefined", () => {
    expect(() => BUILD_vocabSortingQuery(undefined as any, {} as any)).toThrow(
